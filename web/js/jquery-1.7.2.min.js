/* LINE 1306 EDIT SET ATTRIBUTE BUG IE7 */
...
(function(a, b) {
	...
	f.fn.extend({
		...
		/* set from jquery 1.8.3 + try catch*/
		set : function(a, b, d) {
			var e = a.getAttributeNode(d);
			e || ( e = c.createAttribute(d), a.setAttributeNode(e));
			if(OLD_IE){
				try{ return e.value = b + "" }catch(err){ console&&console.log('valHooks.button.set',err,err.name,err.message); }
			}else{
				return e.value = b + ""
			}
		}
		/*set from jquery-1.9.1*//*
		set : function(a, c, d) {
			var e = a.getAttributeNode(r);
